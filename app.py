...
def approve_booking(booking_id):
    ...
    # Guesthouse/Farmhouse has one property-level inventory, so a
    # PropertyBlockedDate blocks the whole property.
    #
    # Resort / Hotel / Service Apartment use physical inventory
    # (unit / room / BHK) blocks.  A property-level block must NOT
    # prevent approval when the booking selected other inventory.
    if booking.property.property_type == "guesthouse":
