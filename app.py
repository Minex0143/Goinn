...
def type3_available(booking_id):
    ...
    # The availability request itself is currently in
    # ``availability_requested`` status. It must not make
    # its own dates appear unavailable during approval.
    #
    # Other pending/availability-requested/approved bookings
    # for overlapping dates are still checked normally.
